      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-eco-text hover:text-primary transition-colors">Home</a>
            <a href="#" className="text-eco-text hover:text-primary transition-colors">Products</a>
            <a href="#" className="text-eco-text hover:text-primary transition-colors">About</a>
            <a href="#" className="text-eco-text hover:text-primary transition-colors">Contact</a>
          </div>
